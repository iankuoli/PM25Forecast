...
import keras
from keras.layers import Input, Conv2D, LSTM, MaxPooling2D, AveragePooling2D, concatenate, Bidirectional, \
                         Activation, TimeDistributed, Dense, Dropout, Flatten, ConvLSTM2D
...
data_update = False
# Notice that 'WIND_SPEED' must be the last feature and 'WIND_DIREC' must be the last second one.
pollution_kind = ['PM2.5', 'O3', 'SO2', 'CO', 'NOx', 'NO', 'NO2', 'AMB_TEMP', 'RH',
                  'PM2.5_x_O3', 'PM2.5_x_CO', 'PM2.5_x_NOx', 'PM2.5_x_NO', 'PM2.5_x_NO2',
                  'O3_x_CO', 'O3_x_NOx', 'O3_x_AMB_TEMP', 'CO_x_NOx',
                  'WIND_SPEED', 'WIND_DIREC']
# target_kind = 'PM2.5'
target_kind = ['PM2.5', 'O3', 'NO', 'NO2', 'NOx', 'PM2.5']
...
cnn_dropout = 0.5
dnn_dropout = 0.5
train_seq_seg = [(72, 1)] #[(12, 1), (24, 2), (48, 3), (72, 6)]
...
# Output layer for the criteria except for PM2.5
air_output_layer1 = BatchNormalization(beta_regularizer=None, epsilon=0.001,
                                       beta_initializer="zero", gamma_initializer="one",
                                       weights=None, gamma_regularizer=None, momentum=0.99, axis=-1)(predict_map0)

air_output_layer1 = Dense(30, kernel_regularizer=l2(regularizer), bias_regularizer=l2(regularizer))(air_output_layer1)
air_output_layer1 = Dropout(0.5)(air_output_layer1)

air_output_layer = BatchNormalization(beta_regularizer=None, epsilon=0.001,
                                      beta_initializer="zero", gamma_initializer="one",
                                      weights=None, gamma_regularizer=None, momentum=0.99, axis=-1)(air_output_layer1)

if output_form[2] == 1:
    air_output_layer = Dense(output_size - 1, kernel_regularizer=l2(regularizer),
                             bias_regularizer=l2(regularizer))(air_output_layer)
else:
    air_output_layer = Dense(output_size - output_form[2], kernel_regularizer=l2(regularizer),
                             bias_regularizer=l2(regularizer), activation='softmax')(air_output_layer)

# Output layer for PM2.5
output_layer1 = BatchNormalization(beta_regularizer=None, epsilon=0.001,
                                   beta_initializer="zero", gamma_initializer="one",
                                   weights=None, gamma_regularizer=None, momentum=0.99, axis=-1)(predict_map0)

output_layer1 = Dense(30, kernel_regularizer=l2(regularizer), bias_regularizer=l2(regularizer))(output_layer1)
output_layer1 = Dropout(0.5)(output_layer1)

output_layer2 = concatenate([output_layer1, air_output_layer1, air_output_layer])

output_layer2 = BatchNormalization(beta_regularizer=None, epsilon=0.001,
                                   beta_initializer="zero", gamma_initializer="one",
                                   weights=None, gamma_regularizer=None, momentum=0.99, axis=-1)(output_layer2)
output_layer2 = Dense(10, kernel_regularizer=l2(regularizer), bias_regularizer=l2(regularizer))(output_layer2)
output_layer2 = Dropout(0.5)(output_layer2)

if output_form[2] == 1:
    output_layer2 = Dense(1, kernel_regularizer=l2(regularizer),
                          bias_regularizer=l2(regularizer))(output_layer2)
else:
    output_layer2 = Dense(output_form[2], kernel_regularizer=l2(regularizer),
                          bias_regularizer=l2(regularizer), activation='softmax')(output_layer2)

output_layer = concatenate([output_layer2, air_output_layer])
